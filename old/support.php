				...
				<div class="col-lg-12">
					<div class="breadcrumb_iner text-center">
						<div class="breadcrumb_iner_item">
							<h2>
								<?php
									if($_GET['option'] == "1"){ echo "Demander un titre"; }
									elseif($_GET['option'] == "2"){ echo "Réclamation"; }
								?> 
							</h2>
						</div>
					</div>
				...
				<div class="container box_1170">
					...
					if(!isset($_GET['option']) or $_GET['option'] == 1)
					{
						...
						?>
							<br>
							<div align="right">
								<button type="submit" class="genric-btn success e-large" style="font-size: 16px;" name="submit">Créer un ticket</button>
							</div>
							<br>
